...
export const BulkOperations: React.FC<BulkOperationsProps> = ({
  ...
  return (
    ...
    >
      <div className="backdrop-blur-2xl bg-white/95 rounded-3xl shadow-2xl border border-white/50 w-full max-w-4xl">
        {/* Modern Header */}
        <div className="bg-gradient-to-r from-blue-500/10 to-indigo-600/10 p-6 border-b border-gray-100/50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-all duration-200"
              >
                Clear Selection
              </button>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-green-600">{stats.categorizedCount}</div>
                    <div className="text-sm text-green-700 font-medium">Categorized</div>
                  </div>
                  <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-orange-600">{stats.uncategorizedCount}</div>
                    <div className="text-sm text-orange-700 font-medium">Uncategorized</div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    onClick={() => onExportSelected(selectedTxns)}
                    className="flex items-center justify-center space-x-3 p-4 bg-white border-2 border-gray-200 
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="font-medium text-gray-900">Export Selected</div>
                      <div className="text-sm text-gray-600">Download as CSV file</div>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="font-medium text-gray-900">Delete Selected</div>
                      <div className="text-sm text-gray-600">Remove permanently</div>
                    </div>
                  </button>
                </div>
