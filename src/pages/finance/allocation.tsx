...
import { AllocationTab } from '@/components/finance/AllocationTab';
...
export default function AllocationPage() {
    ...
    return (
        <Layout>
            <Head>
                <title>Portfolio Allocation | NetFolio</title>
            </Head>
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900">Portfolio Allocation</h1>
                    </div>
                    <p className="text-gray-600">Understand your diversification and concentration risks</p>
                </div>
                ...
                {loading ? (
                    ...
                    <AllocationTab holdings={holdings} />
                )}
            </div>
        </Layout>
    );
