...
export class CategoryMatcher {
  ...
  matchCategory(aiCategory: string): string {
    ...
    const categoryMappings: Record<string, string[]> = {
      ...
      'transport': ['transport', 'transportation', 'travel', 'fuel', 'gas', 'petrol', 'uber', 'taxi', 'car', 'bus', 'train', 'vehicle'],
      ...
      'utilities': ['utilities', 'electric', 'electricity', 'water', 'gas', 'internet', 'phone', 'mobile', 'bills'],
      'insurance': ['insurance', 'policy', 'premium', 'health', 'life', 'car insurance', 'lic'],
      'medical': ['medical', 'health', 'doctor', 'hospital', 'pharmacy', 'medicine', 'dental', 'wellness'],
      'transfer': ['transfer', 'p2p', 'imps', 'neft', 'rtgs', 'upi', 'payment', 'money transfer'],
      'investment': ['investment', 'mutual fund', 'sip', 'fd', 'deposit', 'stocks', 'share', 'investments'],
      'interest': ['interest', 'dividend', 'return', 'earning', 'income', 'credit interest'],
      'salary': ['salary', 'income', 'wages', 'payroll', 'earnings'],
